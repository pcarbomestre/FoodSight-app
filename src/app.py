...
# Historic data
df_hist_path = 'app_data/postgre/hist_data_grasscast.csv'
df_hist = pd.read_csv(df_hist_path)
# Forcast data
df_forcast_path = 'app_data/postgre/forcast_data_grasscast.csv'
df_forcast = pd.read_csv(df_forcast_path)
# SW Grid
sw_grid_path = 'app_data/postgre/southwest_grid/southwest_grid.shp'
...
## Counties
sw_counties_path = 'app_data/postgre/sw_counties/sw_counties.shp'
